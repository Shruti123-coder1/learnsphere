      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex-1">
          ...
          <button
            ...
            className="mt-4 bg-white text-blue-600 px-7 py-2.5 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02] text-sm md:text-base"
          >
            Explore Courses →
          </button>
        </div>
